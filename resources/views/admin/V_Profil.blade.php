...
<div class="flex-1 flex flex-col bg-white">
    <div class="flex-1 p-6 md:p-12 overflow-y-auto bg-gray-50/30 flex items-center">
        <div class="max-w-4xl w-full mx-auto card-form p-8">
            <div class="mb-8">
                <h2 class="text-xl font-bold text-gray-800 border-l-4 border-[#FF6B00] pl-3">Informasi Akun Admin</h2>
            </div>
            ...
            <form id="profileForm" method="POST" action="{{ route('admin.profile.update') }}">
                ...
                <div class="flex justify-end gap-3 mt-6 pt-3 border-t border-gray-100" id="actionButtons">
                    <button type="button" id="editBtn" class="inline-flex items-center gap-2 px-5 py-2 btn-orange rounded-md hover:bg-orange-700 transition font-medium">
                        <i class="fas fa-edit"></i> Edit Profil
                    </button>
                    <button type="submit" id="saveBtn" class="inline-flex items-center gap-2 px-5 py-2 btn-orange rounded-md hover:bg-orange-700 transition font-medium hidden">
                        <i class="fas fa-save"></i> Simpan
                    </button>
                    <button type="button" id="cancelBtn" class="inline-flex items-center gap-2 px-5 py-2 bg-transparent border-2 border-red-500 text-red-500 hover:bg-red-50 hover:text-red-600 rounded-md transition font-medium hidden">
                        <i class="fas fa-times"></i> Batal
                    </button>
                    <button type="button" id="logoutBtn" class="inline-flex items-center gap-2 px-5 py-2 bg-transparent border-2 border-red-600 text-red-600 rounded-md hover:bg-red-50 hover:text-red-700 transition font-medium">
