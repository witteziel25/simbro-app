<footer id="tentang" class="bg-clear-white border-t pt-12 pb-6 px-6">
    <div class="max-w-7xl mx-auto grid md:grid-cols-3 gap-8">
        <div>
            ...
            <div class="flex gap-4 mt-4">
                ...
                <a href="#" class="text-gray-500 hover:text-[#FF6B00]"><i class="fab fa-whatsapp"></i></a>
            </div>
        </div>
        <div>
        ...
        <div>
            ...
            <p class="text-gray-600 text-sm">Minggu & Libur : Tutup</p>
        </div>
    </div>
    <div class="text-center text-[10px] text-gray-400 border-t mt-8 pt-6">&copy; 2026 CV. Mitra Gemuk Bersama. All Rights Reserved.</div>
</footer>
